...
class Pen(Stationary):
    ...
    def draw(self):
        return f'You took a {self.title}. Starting drawing with a pen'
...
class Pencil(Stationary):
    ...
    def draw(self):
        return f'You took a {self.title}. Starting drawing with a pencil'
...
class Handle(Stationary):
    ...
    def draw(self):
        return f'You took a {self.title}. Starting drawing with a handle'
